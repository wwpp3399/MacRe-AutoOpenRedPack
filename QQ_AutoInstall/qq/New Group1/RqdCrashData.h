...
@property(nonatomic) BOOL crashOnceMore; // @synthesize crashOnceMore;
@property(retain, nonatomic) NSMutableDictionary *sceneData; // @synthesize sceneData;
@property(nonatomic, getter=isCaughtError) BOOL caughtError; // @synthesize caughtError;
