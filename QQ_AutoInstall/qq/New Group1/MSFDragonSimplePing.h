...
@interface MSFDragonSimplePing : NSObject
{
    ...
    NSString *_hostName;
    NSData *_hostAddress;
    id <MSFDragonSimplePingDelegate> _delegate;
}

+ (const struct ICMPHeader *)icmpInPacket:(id)arg1;
+ (const struct IPHeader *)ipHeaderInPacket:(id)arg1;
...
@property(nonatomic) id <MSFDragonSimplePingDelegate> delegate; // @synthesize delegate=_delegate;
...
- (void)readData;
- (BOOL)isValidPingResponsePacket:(id)arg1;
