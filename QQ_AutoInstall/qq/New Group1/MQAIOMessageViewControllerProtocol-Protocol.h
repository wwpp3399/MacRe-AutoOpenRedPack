...
@protocol MQAIOMessageViewControllerProtocol <NSObject>
@property(readonly) double minViewWidth;
@property(readonly) BOOL isChatView;
@property(retain) MQSessionID *sessionId;
- (BOOL)canBeRemovedIfNeeded;
- (BOOL)acceptsDraggingInfo:(id <NSDraggingInfo>)arg1;
...
- (id)initWithSession:(MQSessionID *)arg1;
@end
