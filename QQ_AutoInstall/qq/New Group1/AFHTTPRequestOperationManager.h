...
- (id)description;
- (id)DELETE:(id)arg1 parameters:(id)arg2 success:(id)arg3 failure:(id)arg4;
- (id)PATCH:(id)arg1 parameters:(id)arg2 success:(id)arg3 failure:(id)arg4;
- (id)PUT:(id)arg1 parameters:(id)arg2 success:(id)arg3 failure:(id)arg4;
- (id)POST:(id)arg1 parameters:(id)arg2 constructingBodyWithBlock:(id)arg3 success:(id)arg4 failure:(id)arg5;
- (id)POST:(id)arg1 parameters:(id)arg2 success:(id)arg3 failure:(id)arg4;
- (id)HEAD:(id)arg1 parameters:(id)arg2 success:(id)arg3 failure:(id)arg4;
- (id)GET:(id)arg1 parameters:(id)arg2 success:(id)arg3 failure:(id)arg4;
- (id)HTTPRequestOperationWithRequest:(id)arg1 success:(id)arg2 failure:(id)arg3;
- (id)HTTPRequestOperationWithHTTPMethod:(id)arg1 URLString:(id)arg2 parameters:(id)arg3 success:(id)arg4 failure:(id)arg5;
