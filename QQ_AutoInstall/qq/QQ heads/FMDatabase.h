...
- (BOOL)isHasTableIndex:(id)arg1;
- (BOOL)isHasTable:(id)arg1;
...
- (BOOL)executeStatements:(id)arg1 withResultBlock:(id)arg2;
...
- (BOOL)__executeUpdate:(id)arg1 error:(id *)arg2 withArgumentsInArray:(id)arg3 orDictionary:(id)arg4 orVAList:(struct __va_list_tag [1])arg5;
...
- (id)init;
- (BOOL)saveDataToDBFile:(id)arg1;
- (id)loadDataFromDBFile;
