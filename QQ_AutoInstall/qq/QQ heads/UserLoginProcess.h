...
@class MemSig, NSData, NSMutableDictionary, NSString, ProcessLogReport, WloginProtocol, WtloginCustomDataForV2;
...
@property BOOL bNewSTFlag; // @synthesize bNewSTFlag;
...
@property BOOL isInUse; // @synthesize isInUse;
...
@property BOOL hasNewTGTGT; // @synthesize hasNewTGTGT;
...
- (BOOL)addTransTlv:(id)arg1;
- (BOOL)addBasicTlv:(id)arg1;
- (BOOL)genTGTGTbyPasswd:(const char *)arg1 andUin:(unsigned long long)arg2 andFlag:(int)arg3 outTGTGT:(id)arg4 andSigSrc:(unsigned int)arg5 andMUin:(unsigned long long)arg6 andName:(id)arg7;
- (BOOL)genTGTGTbyPasswd:(const char *)arg1 andUin:(unsigned long long)arg2 andFlag:(int)arg3 outTGTGT:(id)arg4 andSigSrc:(unsigned int)arg5 andMUin:(unsigned long long)arg6;
- (void)disconnect;
- (int)connectToRemortServer;
- (unsigned int)pkgHeadUin;
- (void)setPkgNewSTKey:(id)arg1 andAppid:(unsigned int)arg2;
- (BOOL)canUseNewST;
- (void)setNewSTFlag:(BOOL)arg1;
...
- (BOOL)setServerIp:(id)arg1 andPort:(unsigned short)arg2;
...
- (BOOL)setProcessStep:(id)arg1 andResult:(short)arg2;
- (BOOL)setProcessEnd:(id)arg1 andResult:(short)arg2;
- (BOOL)setProcessBegin:(id)arg1 andType:(int)arg2 andName:(id)arg3;
- (BOOL)setProcessBegin:(id)arg1;
