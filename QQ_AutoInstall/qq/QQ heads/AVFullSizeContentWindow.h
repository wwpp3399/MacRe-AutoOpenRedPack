...
@class AVFullSizeContentView;

@interface AVFullSizeContentWindow : NSWindow
{
    AVFullSizeContentView *chromeWindowView_;
}
...
+ (BOOL)shouldUseAVFullSizeContentViewForStyle:(unsigned long long)arg1;
