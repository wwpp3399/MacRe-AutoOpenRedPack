...
- (void)setMSFConnect:(id)arg1;
- (id)ksid;
- (id)loginUserHistory;
- (BOOL)addDomain:(id)arg1 withDomainList:(id)arg2 getPskey:(BOOL)arg3 getPt4token:(BOOL)arg4 checkExpired:(BOOL)arg5;
- (void)clearPT4TokenDomainList;
- (void)clearSKeyDomainList;
- (BOOL)addSKeyDomain:(id)arg1;
...
- (BOOL)switchUser_v2:(id)arg1;
- (BOOL)clearUserLoginData_v2:(id)arg1;
- (BOOL)resetLoginProcess_v2:(long long)arg1;
...
- (BOOL)clearPT4Token:(id)arg1 andAppid:(unsigned int)arg2;
- (BOOL)clearPSkeySig:(id)arg1 andAppid:(unsigned int)arg2;
- (BOOL)clearSig:(id)arg1 andAppid:(unsigned int)arg2 withKey:(id)arg3;
...
- (int)getUserSigAndBasicInfoBySmsVerifyLoginReg_v2:(id)arg1 andAppid:(unsigned int)arg2 andSigBitmap:(unsigned int)arg3 andDelegate:(id)arg4;
- (int)getUserSigAndBasicInfoBySmsVerifyLoginReg_v2:(id)arg1 andAppid:(unsigned int)arg2 andSigBitmap:(unsigned int)arg3 andDelegate:(id)arg4 andTag:(long long *)arg5;
- (int)getUserSigAndBasicInfoBySmsVerifyLoginReg_v2:(id)arg1 andAppid:(unsigned int)arg2 andSigBitmap:(unsigned int)arg3 andOtherAppidNum:(unsigned int)arg4 andOtherAppidList:(unsigned int *)arg5 andDelegate:(id)arg6;
- (int)getUserSigAndBasicInfoBySmsVerifyLoginReg_v2:(id)arg1 andAppid:(unsigned int)arg2 andSigBitmap:(unsigned int)arg3 andOtherAppidNum:(unsigned int)arg4 andOtherAppidList:(unsigned int *)arg5 andDelegate:(id)arg6 andTag:(long long *)arg7;
...
- (BOOL)checkLocalSKeyValid:(id)arg1;
- (BOOL)checkLocalSigValid_v2:(id)arg1 andAppid:(unsigned int)arg2 andSigType:(unsigned int)arg3;
- (BOOL)isNeedLoginWithPasswd_v2:(id)arg1 andAppid:(unsigned int)arg2;
- (id)lastLoginUser;
- (void)clearPasswordSig_v2:(id)arg1;
- (BOOL)hasPasswordSig_v2:(id)arg1;
- (void)dealloc;
