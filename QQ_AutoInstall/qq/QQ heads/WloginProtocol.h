...
@interface WloginProtocol : NSObject <SocketNetworkAdapterProtocol>
{
    ...
    BOOL haveGetNoticeInfo;
    id globalProtocolDet;
}

@property BOOL haveGetNoticeInfo; // @synthesize haveGetNoticeInfo;
...
- (BOOL)onDevLockSmsCheck:(id)arg1;
- (void)updateIPList;
