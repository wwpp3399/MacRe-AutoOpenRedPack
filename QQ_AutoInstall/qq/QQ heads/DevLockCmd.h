...
- (BOOL)getServerResult:(unsigned int *)arg1 andTips:(id)arg2;
- (id)getSppKey;
- (BOOL)getSmsInfo:(unsigned short *)arg1 andTimeLimit:(unsigned short *)arg2;
- (id)getQuerySig;
- (BOOL)decodeDevLockTlvList:(const char *)arg1 andLeftLen:(int *)arg2;
