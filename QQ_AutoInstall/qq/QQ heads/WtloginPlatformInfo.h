...
- (BOOL)removeSig:(id)arg1 withUin:(unsigned int)arg2 andAppId:(unsigned int)arg3;
...
- (BOOL)setNoPwdFlagToConfig:(unsigned int)arg1 andAccount:(id)arg2;
- (BOOL)isPlatNameAccount:(id)arg1;
...
- (BOOL)setSaveRandSeedToConfig:(id)arg1 forAccount:(unsigned int)arg2;
- (BOOL)setSaveSecGUIDInfoToConfig:(unsigned int)arg1;
...
- (BOOL)setSavePwdSigToConfig:(id)arg1 andNoPicSig:(id)arg2 forAccount:(unsigned int)arg3;
- (void)resetKeyChain;
...
- (id)getDeviceVersion;
- (BOOL)closeLowIOSDevLog:(id)arg1;
- (int)writeGuidToPasteBoard:(id)arg1;
- (int)readGuidArrayFromPasteBoard:(id)arg1;
- (void)genGuid;
- (BOOL)writeWtloginConfigFile:(id)arg1 forUin:(unsigned long long)arg2 atomically:(BOOL)arg3;
- (id)macaddress;
- (void)GetHWAddresses;
- (void)GetIPAddresses;
- (void)FreeAddresses;
