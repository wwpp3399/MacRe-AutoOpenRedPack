...
@interface TChatForwardMsgCellBuilder : TChatBaseBubbleBuilder
{
}

- (struct CGSize)bubbleSizeWidthAIOWidth:(double)arg1;
- (double)currentScaleWidthAIOWidth:(double)arg1;
